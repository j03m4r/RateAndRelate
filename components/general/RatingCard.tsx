...
const RatingCard: React.FC<RatingCardProps> = ({
    ...
    const fetchData = async () => {
        const { data, error } = await supabaseClient.from('ratings').select("id, profiles(*), rating, message, replying_to:replying_to_rating_id(profiles(username)), created_at")
                ...
                n===0 ? ( // Show preview of first reply
                    <div className="flex flex-row w-full h-fit">
                        <div className="flex flex-col justify-start h-[18vh] w-1/6">
                            ...
                            <div className="flex flex-row w-full h-3/5 lg:h-3/5">
